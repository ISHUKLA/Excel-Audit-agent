...
async function buildCase9() {
  ...
  guide.getRange("A3:B11").values = [
    ...
    ["Published boundary", "SUMPRODUCT and IRR are outside the current reconstruction catalogue and are retained verbatim."],
  ...
  summary.getRange("B5:B10").formulas = [
    ["=SUMPRODUCT(NetCashFlows,DiscountFactors)"],
    ["=IRR(NetCashFlows)"],
  ...
  return {
    ...
    expected: {
      ...
      summary_outputs: {
        ...
        present_value_margin: { cell: "Profitability Summary!B5", expected_value: 4_600_000, tolerance: 0.01, expected_completeness: "partial", unsupported_functions: ["SUMPRODUCT"] },
        ...
        designated_profitability_result: { cell: "Profitability Summary!B8", expected_value: 4_600_000, tolerance: 0.01, expected_completeness: "partial", unsupported_functions: ["IRR", "SUMPRODUCT"] },
        independent_pricing_result: { cell: "Independent Pricing Reference!B4", expected_value: -4_800_000 },
        illustrative_economic_swing: { cell: "Independent Pricing Reference!B5", expected_value: 9_400_000, tolerance: 0.01, expected_completeness: "partial", unsupported_functions: ["SUMPRODUCT"] },
      },
      expected_finding: {
        category: "hardcoded_numeric_assumption",
      ...
      unsupported_formulas: ["SUMPRODUCT", "IRR"],
      approved_lapse: 0.06,
      embedded_lapse: 0.03,
